...
export const en: DeepPartial<Translations> = {
  ...
  location: {
    ...
    roadAddressBadge: 'Road address',
    lotNumberBadge: 'Lot-number address',
    next: 'Continue',
    alerts: {
      errorTitle: 'Error',
  ...
  guideList: {
    ...
    description: {
      TRANSPORT: 'Find essential travel tips on transportation,\npayments, safety, and language through easy video guides.',
  ...
  guideDetail: {
    categoryBadge: {
      ...
      ORDER: 'Ordering Guide',
      SAFETY: 'Safety Guide',
      LANGUAGE: 'Language Guide',
    },
    startButton: 'Start Guide',
    stepListTitle: 'Step-by-Step Booking Guide',
    totalStepsPrefix: '',
    totalStepsSuffix: ' Steps Total',
    resumeStepPrefix: 'Go to Step ',
    resumeStepSuffix: '',
    stepComingSoonTitle: 'Coming Soon',
    stepComingSoonBody: "This step isn't ready yet. Check back soon!",
  },
  languageGuide: {
    relatedTitle: 'More Useful Phrases',
    previous: 'Back',
    next: 'Next',
    close: 'Finish Guide',
  },
