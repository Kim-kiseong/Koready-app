...
const CHUNGCHEONG_MAP_IMAGE = require('@/assets/images/chungcheong/chungcheong-frame.svg');
...
const CHUNGCHEONG_MAP_ARTWORK: MapArtwork[] = [
  {
    key: 'hot-spring',
    source: require('@/assets/images/chungcheong/map-icons/hot-spring.png'),
    left: 52,
    top: 138,
    width: 100,
    height: 100,
  ...
  {
    key: 'stone-monument',
    source: require('@/assets/images/chungcheong/map-icons/stone-monument.png'),
    left: 133,
    top: 106,
    width: 100,
    height: 100,
  ...
  {
    key: 'aquarium-tunnel',
    source: require('@/assets/images/chungcheong/map-icons/aquarium.png'),
    left: 225,
    top: 100,
    width: 100,
    height: 100,
  ...
  {
    key: 'two-rocks',
    source: require('@/assets/images/chungcheong/map-icons/two-rocks.png'),
    left: -4,
    top: 176,
    width: 100,
    height: 100,
  ...
  {
    key: 'fortress-gate',
    source: require('@/assets/images/chungcheong/map-icons/fortress-gate.png'),
    left: 90,
    top: 185,
    width: 110,
    height: 110,
  ...
  {
    key: 'pork-barbecue',
    source: require('@/assets/images/chungcheong/map-icons/pork-barbecue.png'),
    left: 180,
    top: 210,
    width: 100,
    height: 100,
  ...
  {
    key: 'pavilion-bridge',
    source: require('@/assets/images/chungcheong/map-icons/pavilion-bridge.png'),
    left: 80,
    top: 256,
    width: 110,
    height: 110,
  ...
  {
    key: 'wine-bottle',
    source: require('@/assets/images/chungcheong/map-icons/wine-bottle.png'),
    left: 205,
    top: 275,
    width: 100,
    height: 100,
...
export default function ChungcheongScreen() {
  ...
  const snapPoints = useMemo(() => ['55%', '76%', '96%'], []);
    ...
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      ...
      <View style={styles.contentArea}>
        <View style={[styles.mapStage, { width: mapWidth, height: mapHeight }]}>
          <Image source={CHUNGCHEONG_MAP_IMAGE} style={styles.mapBase} contentFit="contain" />

          <View style={styles.mapOverlay} pointerEvents="none">
            {CHUNGCHEONG_MAP_ARTWORK.map((artwork) => (
              <Image
                key={artwork.key}
            ...
            ListEmptyComponent={
              isLoading ? (
                <View style={styles.loadingState}>
                  ...
                  <CustomText style={styles.loadingText}>충청도 장소를 불러오는 중이에요.</CustomText>
                </View>
              ) : (
